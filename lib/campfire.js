/**
 * Exposes low-level routines to interface with Campfire.  Included are methods
to send a request, stream a request, and run any plugins' initialization
functions
 * @module campfire
 */
...
var campfire = {
  /**
   * Asks the `plugins` module to initialize.
   * @method campfire.initPlugins
   * @param {Array} rooms List of rooms to initialize in
   */
  initPlugins: function initPlugins(rooms) {
    plugins.init(rooms);
  },
